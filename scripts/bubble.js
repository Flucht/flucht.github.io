...
d3.json("data/map-data.json", function(data) {
  ...
  var simulation = d3.forceSimulation()
      ...
      .force("collide", d3.forceCollide().strength(.2).radius(function(d){ return (size(d.properties.hasTotal.total)+5) }).iterations(1)) // Force that avoids circle overlapping
